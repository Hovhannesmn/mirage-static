...
- **Global scope**: `/Users/hmanukyan/Projects/mirage/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/hmanukyan/Projects/mirage/.claude/notes/`)
...
2. Glob `/Users/hmanukyan/Projects/mirage/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/hmanukyan/Projects/mirage/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/hmanukyan/Projects/mirage/.claude/notes/` — works in any directory
